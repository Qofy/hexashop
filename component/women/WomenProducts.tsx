    ...
    <div className="py-6 md:py-12 px-4 md:px-6">
      ...
      {isLoading && (
        <div className="flex justify-center items-center py-6 md:py-12">
          <div className="text-center">
            ...
            <p className="mt-4 text-sm md:text-base text-gray-600">{womenContent?.loadingMessage}</p>
          </div>
        </div>
      )}
      ...
      {!isLoading && !isError && products.length === 0 && (
        <div className="text-center py-6 md:py-12">
          <p className="text-sm md:text-lg text-gray-500">{womenContent?.emptyMessage}</p>
        </div>
      )}
    </div>
  );
